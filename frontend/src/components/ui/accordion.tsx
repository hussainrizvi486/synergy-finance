...
>(({ className = "", children, ...props }, ref) => (
    <AccordionPrimitive.Header className="flex">
        ...
        >
            {children}
            <ChevronDown 
                className="h-4 w-4 shrink-0 text-muted-foreground transition-transform duration-300 ease-in-out group-hover:text-primary data-[state=open]:text-primary cursor-pointer" 
                aria-hidden="true"
                style={{
